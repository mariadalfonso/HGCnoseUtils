...
# with command line options: step3 --conditions auto:phase2_realistic -n 10 --era Phase2C6 --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --geometry Extended2023D31 --filein file:step2.root --fileout file:step3.root
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('RECO',eras.Phase2C6)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/eos/user/d/dalfonso/VBS/WWjj_SS_ewk/NOSE/WWjj_SS_ewk_DIGI_HGCNose_1to2.root',
                                      'file:/eos/user/d/dalfonso/VBS/WWjj_SS_ewk/NOSE/WWjj_SS_ewk_DIGI_HGCNose_3to4.root',
                                      'file:/eos/user/d/dalfonso/VBS/WWjj_SS_ewk/NOSE/WWjj_SS_ewk_DIGI_HGCNose_5to6.root',
                                      'file:/eos/user/d/dalfonso/VBS/WWjj_SS_ewk/NOSE/WWjj_SS_ewk_DIGI_HGCNose_7to8.root',
                                      'file:/eos/user/d/dalfonso/VBS/WWjj_SS_ewk/NOSE/WWjj_SS_ewk_DIGI_HGCNose_9to10.root'
                                  ),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/dalfonso/WWjj_SS_ewk_RECO_HGCNose.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/dalfonso/step3_inMINIAODSIM.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/dalfonso/step3_inDQM.root'),
